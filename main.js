var app = (function () {
    var startDate = "2024-10-04"; // Original Start Date, used to know the current heardle
    var seed = 564815687; // seed used for rng to select today's music
    ...
    function Ce(e) {
        ...
        let answerValue = guess.answer + "";
        let yearValue = "Year: " + (guess.yearHint || guess.year || "");
        let consoleValue = "Console: " + (guess.consoleHint || "");
        let gameValue = "Game: " + (guess.gameHint || "");
        let categoryValue = "Category: " + (guess.categoryHint || "");
        ...
        return {
            c() {
                ...
                answerText = _(answerValue);
                yearText = _(yearValue);
                consoleText = _(consoleValue);
                gameText = _(gameValue);
                categoryText = _(categoryValue);

                M(wrapper, "class", "guess-result-grid");
                M(answerRow, "class", "guess-answer-column");
                M(hintsWrapper, "class", "guess-hints-column");

                M(yearRow, "class", "guess-hint-row");
                M(consoleRow, "class", "guess-hint-row");
                M(gameRow, "class", "guess-hint-row");
                M(categoryRow, "class", "guess-hint-row");
            },
            ...
            m(e, r) {
                ...
                p(wrapper, answerRow);
                p(answerRow, answerText);

                p(wrapper, hintsWrapper);

                p(hintsWrapper, yearRow);
                p(yearRow, yearText);

                p(hintsWrapper, consoleRow);
                p(consoleRow, consoleText);

                p(hintsWrapper, gameRow);
                p(gameRow, gameText);

                p(hintsWrapper, categoryRow);
                p(categoryRow, categoryText);
            },
            ...
            p(e, t) {
                if (1 & t) {
                    ...
                    answerValue = guess.answer + "";
                    yearValue = "Year: " + (guess.yearHint || guess.year || "");
                    consoleValue = "Console: " + (guess.consoleHint || "");
                    gameValue = "Game: " + (guess.gameHint || "");
                    categoryValue = "Category: " + (guess.categoryHint || "");

                    $(answerText, answerValue);
                    $(yearText, yearValue);
                    $(consoleText, consoleValue);
                    $(gameText, gameValue);
            ...
            [
                ...
                () => {
                    ...
                    let o =
                        ...
                        t +
                        "\n\n" +
                        "https://nterrien.github.io/pkmn-heardle/";
                    if (
                        !navigator.share ||
    ...
    function jn(e, t, n) {
        ...
        return [
            ...
            function (e) {
                ...
                var correctMusic = musicNameList.find((m) => m.id == l.correctAnswer);
                ...
                if (!r && findMusic && correctMusic) {
                    if (findMusic.year < correctMusic.year) {
                        yearHint = "Newer than " + findMusic.year + ".";
                    ...
                    categoryHint = findMusic.category == correctMusic.category ? findMusic.category + " is correct!" : findMusic.category + " is incorrect.";

                    gameHint = findMusic.game == correctMusic.game ? findMusic.game + " is correct!" : findMusic.game + " is incorrect.";

                    genreHint = findMusic.genre == correctMusic.genre ? findMusic.genre + " is correct!" : findMusic.genre + " is incorrect.";
                }
                ...
                r ||
                    ...
                    n(
                        ...
                        (v = v.concat({
                            ...
                            id: findMusic?.id || "",
                            console: findMusic?.console || "",
                            year: findMusic?.year || "",
                            game: findMusic?.game || "",
                            category: findMusic?.category || "",
